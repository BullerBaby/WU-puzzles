    ...
    steps: [
      {
        ...
        state: {
          positions: { W:'-e1', B:'-c2', S:'-d1', H:'-g1', o1:'e2', o2:'h2', o3:'f1', o4:'g2' },
          glory: [0, 0],
          ...
          features: [
            { type: 'treasure', label: '1', hex: '-d2' },
            { type: 'treasure', label: '2', hex: '-f2' },
            { type: 'treasure', label: '3', hex: '-h2' },
            { type: 'treasure', label: '4', hex: 'e3' },
      ...
      },
      {
        ...
        poll: {
          ...
          options: [
            'o3 at f1 — closest, clean charge target',
            'o1 at e2 — opp leader, biggest bounty',
            'o4 at g2 — flank threat to the Sharpener',
            "o2 at h2 — out of range now (don't condemn)",
          ],
          correct: 0,
        },
        diff: {
      ...
      {
        notation: 'W>f1 @e1 ×4† o3  (HC / -)  [+P]  ↑W  (G:1-0)',
        title: 'R2.1 — Wielder charges and executes',
        explanation: "W charges -e1 → e1, attacks o3 at f1. Hammer + crit vs blank: 2 hits, 3 base + 1 Condemned = 4. Twist the Knife played in the following power step adds glory on the kill. Trial and Execution gives +1 power card (Murderous Charge). W inspires.",
        ...
        diff: {
          ...
          features: [
            ...
            { type: 'treasure', label: '2', hex: '-f2' },
            { type: 'treasure', label: '3', hex: '-h2' },
            { type: 'treasure', label: '4', hex: 'e3', delved: true },
            { type: 'treasure', label: '5', hex: 'g3' },
            { type: 'aqua', hex: 'd0' },
            { type: 'aqua', hex: 'h0' },
          ],
      ...
      {
        notation: 'o1 xe1 ×2  W[w×2]  (SS / D-)',
        title: 'R2.2 — Opponent leader retaliates',
        explanation: "o1 attacks W from e2 (no move). Two swords vs two dodge: 2 hits − 1 save = 1 net, 2 damage. Opponent plays Sidestep in the power step to reposition after. Wielder on 3 HP.",
      ...
      {
        notation: 'S xe2 ×1  o1[w×1]  (H- / -)',
        title: 'R2.3 — Scriptor pings the leader',
        explanation: "S range attack on o1 (3 hexes from -d1). Hammer + blank, opponent rolls blank shield — 1 damage. Bearer (B) has gone on Guard this round for defensive coverage in our deployment zone.",
      ...
      {
        notation: '[Discorporate: H → h1]',
        title: 'R2.4 — Discorporate (warscroll ability)',
        explanation: "Teleport Sharpener from -g1 to h1, flanking o2 and o4 for R3. No card spent.",
        poll: {
          question: "What's the right call here?",
          options: [
            'h1 — flank o2 and o4 for R3',
            'd1 — engage opp leader from behind',
            '-f1 — stack next to W for Whet the Blade',
